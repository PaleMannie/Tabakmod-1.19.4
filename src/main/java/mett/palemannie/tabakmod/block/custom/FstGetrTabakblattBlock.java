...
public class FstGetrTabakblattBlock extends Block {
    //------------------------------------------------------------------------------------------------------------------
    public FstGetrTabakblattBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void randomTick(BlockState pState, ServerLevel pLevel, BlockPos pPos, RandomSource pRandom) {
        ...
        if(chance >= pRandom.nextFloat() && pLevel.isDay() && pLevel.canSeeSky(pPos)){
            pLevel.setBlockAndUpdate(pPos, ModBlocks.GETROCKNETER_TABAKBLATT.get().defaultBlockState());
